...
//Complete
public class TC_01_Verify_GooglePageLaunchingTest extends CoreTest {
	
	@BeforeTest
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_01_Verify_GooglePageLaunchingTest")) {
	...
	public void VerifyGoogleLaunchingPage() throws IOException
	{
		...
		System.out.println("<--------Test Case 1st is Successfully Completed-------->");
			...
			testUtil.captureScreenshot("TC_01_Verify_GooglePageLaunchingTest");
	...
	{
		return testUtil.getData("TC_01_Verify_GooglePageLaunchingTest");
	}
}	