...
//Complete
public class TC_07_VerifySearchOperationProperlyTest extends CoreTest{

	SoftAssert softAssert;
	@BeforeTest
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_07_VerifySearchOperationProperlyTest")) 
		{
	...
	public void CountGivenLinks() throws IOException
	{
		...
		{
		testUtil.captureScreenshot("TC_07_VerifySearchOperationProperlyTest");
		...
		{
			return testUtil.getData("TC_07_VerifySearchOperationProperlyTest");
		}
