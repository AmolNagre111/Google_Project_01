...
//Completed
public class TC_08_VerifyAllGoogleProductsTest extends CoreTest{
	
	SoftAssert softAssert;
	@BeforeTest
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_08_VerifyAllGoogleProductsTest")) 
		{
	...
	public void VerifyGoogleAllApps() throws IOException
	{
		...
		testUtil.captureScreenshot("TC_08_VerifyAllGoogleProductsTest");
...
{
	return testUtil.getData("TC_08_VerifyAllGoogleProductsTest");
}
