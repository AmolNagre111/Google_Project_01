...
public class TC_09_VerifyLoginToGmailTest extends CoreTest{
	SoftAssert softAssert;
	@BeforeTest
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_09_VerifyLoginToGmailTest")) 
		{
	...
	public void VerifyGoogleLaunchingPage(String email,String password) throws IOException
	{
		...
		testUtil.captureScreenshot("TC_09_VerifyLoginToGmailTest");
		...
		{
			return testUtil.getData("TC_09_VerifyLoginToGmailTest");
		}
}
