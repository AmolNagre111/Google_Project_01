...
//Complete
public class TC_06_OpenCloseBrowsersTest extends CoreTest{
		...
		public void isSkip() {
			...
			if (!testUtil.isExecutable("TC_06_OpenCloseBrowsersTest")) 
			{
		...
		{
			return testUtil.getData("TC_06_OpenCloseBrowsersTest");
		}
