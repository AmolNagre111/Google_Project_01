...
public class TC_03_VerifyAllGoogleApps_LaunchingTest extends CoreTest{
	SoftAssert softAssert;
		@BeforeTest
		public void isSkip() {
			
			if (!testUtil.isExecutable("TC_03_VerifyAllGoogleApps_LaunchingTest")) {
		...
		{
			testUtil.captureScreenshot("TC_03_VerifyAllGoogleApps_LaunchingTest");
		...
		{
		return testUtil.getData("TC_03_VerifyAllGoogleApps_LaunchingTest");
