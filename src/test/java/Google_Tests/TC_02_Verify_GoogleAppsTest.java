...
public class TC_02_Verify_GoogleAppsTest extends CoreTest {
	SoftAssert softAssert;	
	@BeforeTest	//Runmode check is executable or not
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_02_Verify_GoogleAppsTest")) {
	...
	public void VerifyGoogleAllApps() throws IOException
	{
		...
		//Account.click();//just for confirmation
			...
			testUtil.captureScreenshot("TC_02_Verify_GoogleAppsTest");
	...
	{
		return testUtil.getData("TC_02_Verify_GoogleAppsTest");
	}
}
