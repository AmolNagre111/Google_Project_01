...
public class TC_04_SIgnInAllGoogleAppsTest extends CoreTest{
	SoftAssert softAssert;
	@BeforeTest
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_04_SIgnInAllGoogleAppsTest")) {
	...
	public void VerifyGoogleLaunchingPage(String email,String password) throws IOException
	{
		try{
			...
			Thread.sleep(3000);
			//wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(object.getProperty("ClickEnglishLink")))).click();
			...
			testUtil.captureScreenshot("TC_04_SIgnInAllGoogleAppsTest");
	...
	{
		return testUtil.getData("TC_04_SIgnInAllGoogleAppsTest");
	}
}
