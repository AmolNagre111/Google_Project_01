...
public class TC_10_VerifyTotalMailRecTest extends CoreTest {

	SoftAssert softAssert;
	@BeforeTest
	public void isSkip() {
		
		if (!testUtil.isExecutable("TC_10_VerifyTotalMailRecTest")) 
		{
...
/*			//handle the child window
		...
		testUtil.captureScreenshot("TC_10_VerifyTotalMailRecTest");
		...
		{
			return testUtil.getData("TC_10_VerifyTotalMailRecTest");
		}
}
