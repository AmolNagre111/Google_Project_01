 ...
 */
//Complete
public class TC_05_VerifyAllLanguageLinksTest extends CoreTest{

	SoftAssert softAssert;
	@BeforeTest
	public void isSkip() {
		if (!testUtil.isExecutable("TC_05_VerifyAllLanguageLinksTest")) 
		{
	...
	public void VerifyGoogleLaunchingPage() throws IOException
	{
		try{
			...
			testUtil.captureScreenshot("TC_05_VerifyAllLanguageLinksTest");
	...
	{
		return testUtil.getData("TC_05_VerifyAllLanguageLinksTest");
	}
